...
export async function getMyEarnings(req: Request, res: Response) {
  try {
    ...
    console.log("commissionAgg:", Date.now() - t1, "ms");
    ...
    console.log("monthlyAgg:", Date.now() - t2, "ms");
    ...
    console.log("totalPaidLeads:", Date.now() - t3, "ms");
    ...
    console.log("dealAgg:", Date.now() - t4, "ms");
    ...
    console.log("pendingLeads:", Date.now() - t5, "ms");
    ...
    console.log("withdrawnAgg:", Date.now() - t6, "ms");
    ...
    console.log("pendingRequestsAgg:", Date.now() - t7, "ms");

    const t8 = Date.now();
    const monthlyBreakdown = await getMonthlyBreakdown(studentId);
    console.log("monthlyBreakdown:", Date.now() - t8, "ms");
